...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C01241 implements AnimationListener {
        C01241() {
        }
    ...
    class C01252 extends Animation {
        C01252() {
        }
    ...
    class C01263 extends Animation {
        C01263() {
        }
    ...
    class C01274 extends Animation {
    ...
    class C01285 implements AnimationListener {
        C01285() {
        }
    ...
    class C01296 extends Animation {
        C01296() {
        }
    ...
    class C01307 extends Animation {
        C01307() {
        }
    ...
    class C01318 extends Animation {
        C01318() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C01241();
        this.mAnimateToCorrectPosition = new C01296();
        this.mAnimateToStartPosition = new C01307();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C01252();
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C01263();
    ...
    private Animation startAlphaAnimation(int startingAlpha, int endingAlpha) {
        ...
        Animation alpha = new C01274(startingAlpha, endingAlpha);
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C01318();
