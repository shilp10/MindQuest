...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C01563 implements Runnable {
        C01563() {
        }
    ...
    static {
        ATTRS = new int[]{C0149R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C03231();
        this.mRemoveActionBarHideOffset = new C01552();
        this.mAddActionBarHideOffset = new C01563();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0149R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0149R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0149R.id.action_bar));
        }
    }
