...
import android.support.v7.recyclerview.C0150R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static class C01763 implements Interpolator {
        C01763() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0150R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0150R.styleable.RecyclerView_android_orientation, RecyclerView.VERTICAL);
            properties.spanCount = a.getInt(C0150R.styleable.RecyclerView_spanCount, RecyclerView.VERTICAL);
            properties.reverseLayout = a.getBoolean(C0150R.styleable.RecyclerView_reverseLayout, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            properties.stackFromEnd = a.getBoolean(C0150R.styleable.RecyclerView_stackFromEnd, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            a.recycle();
            return properties;
        }
    }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C01771 implements Creator<SavedState> {
            C01771() {
            }
    ...
    class C03044 implements ProcessCallback {
        C03044() {
        }
    ...
    class C03055 implements Callback {
        C03055() {
        }
    ...
    class C03066 implements Callback {
        C03066() {
        }
    ...
    static {
        ...
        sQuinticInterpolator = new C01763();
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C01741();
        ...
        this.mItemAnimatorRunner = new C01752();
        this.mViewInfoProcessCallback = new C03044();
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0150R.styleable.RecyclerView, defStyle, TOUCH_SLOP_DEFAULT);
            String layoutManagerName = a.getString(C0150R.styleable.RecyclerView_layoutManager);
            a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03055());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03066());
    }
