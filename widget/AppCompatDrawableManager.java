    ...
    public Drawable getDrawable(@NonNull Context context, @DrawableRes int resId, boolean failIfNotKnown) {
        ...
        if (drawable != null) {
            ...
            if (tintList != null) {
                ...
                return new LayerDrawable(new Drawable[]{getDrawable(context, C0149R.drawable.abc_cab_background_internal_bg), getDrawable(context, C0149R.drawable.abc_cab_background_top_mtrl_alpha)});
