...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    class C01984 implements Runnable {
        final /* synthetic */ RecoverAnimation val$anim;
        final /* synthetic */ int val$swipeDir;

        C01984(RecoverAnimation recoverAnimation, int i) {
    ...
    public static abstract class Callback {
        ...
        static class C01991 implements Interpolator {
            C01991() {
            }
        ...
        static class C02002 implements Interpolator {
            C02002() {
            }
        ...
        static {
            sDragScrollInterpolator = new C01991();
            sDragViewScrollCapInterpolator = new C02002();
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == ItemTouchHelper.ACTIVE_POINTER_ID_NONE) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0150R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    class C03092 implements OnItemTouchListener {
        C03092() {
        }
    ...
    class C03105 implements ChildDrawingOrderCallback {
        C03105() {
        }
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        class C03111 implements AnimatorUpdateListenerCompat {
            final /* synthetic */ ItemTouchHelper val$this$0;

            C03111(ItemTouchHelper itemTouchHelper) {
        ...
        public RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator.addUpdateListener(new C03111(ItemTouchHelper.this));
    ...
    class C03323 extends RecoverAnimation {
        ...
        C03323(ViewHolder x0, int x1, int x2, float x3, float x4, float x5, float x6, int i, ViewHolder viewHolder) {
            this.val$swipeDir = i;
    ...
    private void postDispatchSwipe(RecoverAnimation anim, int swipeDir) {
        this.mRecyclerView.post(new C01984(anim, swipeDir));
    }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C03105();
            }
