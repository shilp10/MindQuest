...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00381 implements ThreadFactory {
    ...
    class C00393 extends FutureTask<Result> {
        C00393(Callable x0) {
            super(x0);
        }
    ...
    class C02642 extends WorkerRunnable<Params, Result> {
        C02642() {
            super();
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C02642();
        this.mFuture = new C00393(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00404.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
