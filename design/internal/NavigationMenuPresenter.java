        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            switch (getItemViewType(position)) {
                case VIEW_TYPE_NORMAL /*0*/:
                    ...
                    itemView.initialize(((NavigationMenuTextItem) this.mItems.get(position)).getMenuItem(), VIEW_TYPE_NORMAL);
                case VIEW_TYPE_SUBHEADER /*1*/:
                ...
                case VIEW_TYPE_SEPARATOR /*2*/:
                    ...
                    holder.itemView.setPadding(VIEW_TYPE_NORMAL, item.getPaddingTop(), VIEW_TYPE_NORMAL, item.getPaddingBottom());
                default:
            }
        }
