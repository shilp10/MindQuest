...
public class FloatingActionButton extends ImageButton {
    ...
    class C02411 implements ShadowViewDelegate {
        C02411() {
        }
    ...
    class C02422 implements InternalVisibilityChangedListener {
        final /* synthetic */ OnVisibilityChangedListener val$listener;

        C02422(OnVisibilityChangedListener onVisibilityChangedListener) {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        class C02431 implements AnimatorUpdateListener {
            ...
            C02431(FloatingActionButton floatingActionButton) {
                ...
                if (this.mFabTranslationY != targetTransY) {
                    ...
                    if (Math.abs(currentTransY - targetTransY) > ((float) fab.getHeight()) * 0.667f) {
                        if (this.mFabTranslationYAnimator == null) {
                            ...
                            this.mFabTranslationYAnimator.setUpdateListener(new C02431(fab));
                        }
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        ShadowViewDelegate delegate = new C02411();
