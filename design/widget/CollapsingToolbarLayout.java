...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C02381 implements OnApplyWindowInsetsListener {
        C02381() {
        }
    ...
    class C02392 implements AnimatorUpdateListener {
        C02392() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02381());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.setUpdateListener(new C02392());
