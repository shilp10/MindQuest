...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class C02673 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ String val$parentId;

        C02673(Object x0, String str, ConnectionRecord connectionRecord) {
            this.val$parentId = str;
    ...
    class C02684 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C02684(Object x0, ResultReceiver resultReceiver) {
    ...
    private class ServiceBinder extends Stub {
        ...
        class C00531 implements Runnable {
            ...
            C00531(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str, Bundle bundle, int i) {
        ...
        class C00542 implements Runnable {
            ...
            C00542(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
            }
        ...
        class C00553 implements Runnable {
            ...
            C00553(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
                this.val$id = str;
            }
        ...
        class C00564 implements Runnable {
            ...
            C00564(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str) {
                this.val$callbacks = iMediaBrowserServiceCompatCallbacks;
                this.val$id = str;
            }
        ...
        class C00575 implements Runnable {
            final /* synthetic */ String val$mediaId;
            final /* synthetic */ ResultReceiver val$receiver;

            C00575(String str, ResultReceiver resultReceiver) {
        ...
        public void connect(String pkg, Bundle rootHints, IMediaBrowserServiceCompatCallbacks callbacks) {
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.post(new C00531(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00542(callbacks));
        }

        public void addSubscription(String id, IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00553(callbacks, id));
        }

        public void removeSubscription(String id, IMediaBrowserServiceCompatCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.post(new C00564(callbacks, id));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.post(new C00575(mediaId, receiver));
            }
        }
    }
    ...
    public void setSessionToken(Token token) {
        if (token == null) {
            ...
            this.mSession = token;
            this.mHandler.post(new C00511(token));
        }
    }
    ...
    public void notifyChildrenChanged(@NonNull String parentId) {
        ...
        this.mHandler.post(new C00522(parentId));
    }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection) {
        Result<List<MediaItem>> result = new C02673(parentId, parentId, connection);
    ...
    private void performLoadItem(String itemId, ResultReceiver receiver) {
        Result<MediaItem> result = new C02684(itemId, receiver);
