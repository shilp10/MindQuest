...
class TransportMediatorJellybeanMR2 {
    ...
    class C00621 implements OnWindowAttachListener {
        C00621() {
        }
    ...
    class C00632 implements OnWindowFocusChangeListener {
        C00632() {
        }
    ...
    class C00643 extends BroadcastReceiver {
        C00643() {
        }
    ...
    class C00654 implements OnAudioFocusChangeListener {
        C00654() {
        }
    ...
    class C00665 implements OnGetPlaybackPositionListener {
        C00665() {
        }
    ...
    class C00676 implements OnPlaybackPositionUpdateListener {
        C00676() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C00621();
        this.mWindowFocusListener = new C00632();
        this.mMediaButtonReceiver = new C00643();
        this.mAudioFocusChangeListener = new C00654();
        this.mGetPlaybackPositionListener = new C00665();
        this.mPlaybackPositionUpdateListener = new C00676();
        this.mPlayState = 0;
