...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplBase {
        ...
        class C00441 implements Runnable {
            ...
            C00441(ServiceConnection serviceConnection) {
        ...
        class C00452 implements Runnable {
            ...
            C00452(ItemCallback itemCallback, String str) {
        ...
        class C00464 implements Runnable {
            ...
            C00464(ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
            }
        ...
        class C00475 implements Runnable {
            ...
            C00475(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, String str, Token token, Bundle bundle) {
        ...
        class C00486 implements Runnable {
            final /* synthetic */ IMediaBrowserServiceCompatCallbacks val$callback;

            C00486(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks) {
                this.val$callback = iMediaBrowserServiceCompatCallbacks;
            }
        ...
        class C00497 implements Runnable {
            ...
            C00497(IMediaBrowserServiceCompatCallbacks iMediaBrowserServiceCompatCallbacks, List list, String str) {
                this.val$callback = iMediaBrowserServiceCompatCallbacks;
                this.val$list = list;
        ...
        class C02663 extends ResultReceiver {
            final /* synthetic */ ItemCallback val$cb;
            final /* synthetic */ String val$mediaId;

            C02663(Handler x0, ItemCallback itemCallback, String str) {
                this.val$cb = itemCallback;
                this.val$mediaId = str;
                super(x0);
            }
        ...
        public void connect() {
            if (this.mState != 0) {
                ...
                if (!bound) {
                    this.mHandler.post(new C00441(thisConnection));
                }
            }
        }
        ...
        public void getItem(@NonNull String mediaId, @NonNull ItemCallback cb) {
            if (TextUtils.isEmpty(mediaId)) {
                ...
                this.mHandler.post(new C00452(cb, mediaId));
            } else {
                try {
                    this.mServiceBinder.getMediaItem(mediaId, new C02663(this.mHandler, cb, mediaId));
                } catch (RemoteException e) {
                    Log.i(TAG, "Remote error getting media item.");
                    this.mHandler.post(new C00464(cb, mediaId));
                }
            }
        }
