...
public class AsyncListUtil<T> {
    ...
    class C02921 implements MainThreadCallback<T> {
        C02921() {
        }
    ...
    class C02932 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C02921();
        this.mBackgroundCallback = new C02932();
        this.mTClass = klass;
