...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C02941 implements MainThreadCallback<T> {
        ...
        class C01511 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = C02941.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case C02941.UPDATE_ITEM_COUNT /*1*/:
                            C02941.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case C02941.ADD_TILE /*2*/:
                            C02941.this.val$callback.addTile(msg.arg1, (Tile) msg.data);
                            break;
                        case C02941.REMOVE_TILE /*3*/:
                            C02941.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C02941.this.mQueue.next();
                }
            }
        }

        C02941(MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
            this.mQueue = new MessageQueue();
            this.mMainThreadHandler = new Handler(Looper.getMainLooper());
            this.mMainThreadRunnable = new C01511();
        }
    ...
    class C02952 implements BackgroundCallback<T> {
        ...
        class C01521 implements Runnable {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = C02952.this.mQueue.next();
                    if (msg != null) {
                        switch (msg.what) {
                            case C02952.REFRESH /*1*/:
                                C02952.this.mQueue.removeMessages(C02952.REFRESH);
                                C02952.this.val$callback.refresh(msg.arg1);
                                break;
                            case C02952.UPDATE_RANGE /*2*/:
                                C02952.this.mQueue.removeMessages(C02952.UPDATE_RANGE);
                                C02952.this.mQueue.removeMessages(C02952.LOAD_TILE);
                                C02952.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case C02952.LOAD_TILE /*3*/:
                                C02952.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case C02952.RECYCLE_TILE /*4*/:
                                C02952.this.val$callback.recycleTile((Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
                    ...
                    C02952.this.mBackgroundRunning.set(false);
                    return;
                }
            }
        }

        C02952(BackgroundCallback backgroundCallback) {
            ...
            this.mBackgroundRunnable = new C01521();
        }
