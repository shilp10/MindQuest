...
class AccessibilityManagerCompatIcs {
    ...
    static class C01041 implements AccessibilityStateChangeListener {
        final /* synthetic */ AccessibilityStateChangeListenerBridge val$bridge;

        C01041(AccessibilityStateChangeListenerBridge accessibilityStateChangeListenerBridge) {
